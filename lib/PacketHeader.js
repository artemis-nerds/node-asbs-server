...
function PacketHeader(buffer, client) {
    ...
    if (Server.knownPackets.hasOwnProperty(this.type)) {
        ...
        while (data.pointer < this.packetLength) {
            ...
            else throw new Error('Unknown packet! Type is: ' + this.type + ', subtype is: ' + this.subtype);
            ...
            try {
                ...
                var message = 'Error while parsing packet of type ' + packetType;
                var str = '';
                ...
                var newError = new Error(message, e.fileName, e.lineNumber);
        ...
        // Some packets such as baseUpdate may return more
        // than one payload
