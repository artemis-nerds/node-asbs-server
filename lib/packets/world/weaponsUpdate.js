...
exports.pack = function(writer, data) {
    ...
    setUpdateProps(writer, data, 3, {
        ...
        unloadTime4:        [15, 'float'],
        unloadTime5:        [14, 'float'],
        unloadTime6:        [13, 'float'],
        tubeUsed1:          [12, 'byte'],
        tubeUsed2:          [11, 'byte'],
        tubeUsed3:          [10, 'byte'],
        tubeUsed4:          [9,  'byte'],
        ...
        tubeUsed6:          [23, 'byte'],
        tubeContents1:      [22, 'byte'],
        tubeContents2:      [21, 'byte'],
        tubeContents3:      [20, 'byte'],
        tubeContents4:      [19, 'byte'],
        tubeContents5:      [18, 'byte'],
        tubeContents6:      [17, 'byte']
    });
};
exports.unpack = function(data) {
    ...
    // tubeUsed is 0 if unloading, 2 if loading, 1 if loaded, 3 if unloading
    // 0 -> 2 -> 1 -> 3 -> 0 (loading then unloading)
    // 0 -> 2 -> 1 -> 0 (firing)
